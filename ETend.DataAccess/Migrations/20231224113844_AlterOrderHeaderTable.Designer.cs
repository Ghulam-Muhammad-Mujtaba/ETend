...
namespace ETend.DataAccess.Migrations
{
    ...
    [Migration("20231224113844_AlterOrderHeaderTable")]
    partial class AlterOrderHeaderTable
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ETend.Models.Customer", b =>
                {
                    ...
                    b.Property<double?>("EWalletBalance")
                        .HasColumnType("float");
            ...
            modelBuilder.Entity("ETend.Models.OrderDetail", b =>
                {
                    b.HasOne("ETend.Models.OrderHeader", "OrderHeader")
                        .WithMany()
                        .HasForeignKey("OrderId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("ETend.Models.Product", "Product")
                        .WithMany()
