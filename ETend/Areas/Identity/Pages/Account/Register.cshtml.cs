...
namespace ETend.Areas.Identity.Pages.Account
{
    public class RegisterModel : PageModel
    {
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                user.EWalletBalance = 0; //adding E-Wallet balance to 0 initially
                ...
                if (result.Succeeded)
                {
                    ...
                    if (Input.Role == null)
                    {
                        await _userManager.AddToRoleAsync(user, Constants.Constants.Role_User_Indi);
                    }
                    else
                    {
        ...
        private ETend.Models.Customer CreateUser()
        {
            try
            {
                return Activator.CreateInstance<ETend.Models.Customer>();
            }
            catch
            {
